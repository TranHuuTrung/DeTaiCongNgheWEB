...
<?php
   ...
   //khi lấy xong từ khóa cần tìm kiếm thì thực hiện câu sql
   $sql = "SELECT * from posts WHERE content like '%$search_key%' OR title like '%$search_key%'
           OR theme like '%$search_key%' ";

  //query lên cơ sở dữ liệu
...
<div id="navigation" class="wrap-inner">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="./main_of_admin.php">HOME</a>
